            ...
            <div class="row gy-4 mobile-box-wrapper">
                ...
                <div class="col-3">
                    <div class="mobile-box link-item">
                        ...
                        <img src="{{ getFile('d-icon', '2.png') }}" alt="icon">
                ...
                <div class="col-3">
                    <div class="mobile-box link-item">
                        ...
                        <img src="{{ getFile('d-icon', '3.png') }}" alt="icon">
                ...
                <div class="col-3">
                    <div class="mobile-box link-item">
                        ...
                        <img src="{{ getFile('d-icon', '4.png') }}" alt="icon">
                ...
                <div class="col-3">
                    <div class="mobile-box link-item">
                        ...
                        <img src="{{ getFile('d-icon', '5.png') }}" alt="icon">
                ...
                <div class="col-3">
                    <div class="mobile-box link-item">
                        <a href="{{ route('user.transaction.log') }}" class="item-link"></a>
                        <img src="{{ getFile('d-icon', '6.png') }}" alt="icon">
                ...
                <div class="col-3">
                    <div class="mobile-box link-item">
                        ...
                        <img src="{{ getFile('d-icon', '7.png') }}" alt="icon">
                ...
                <div class="col-3">
                    <div class="mobile-box link-item">
                        ...
                        <img src="{{ getFile('d-icon', '8.png') }}" alt="icon">
                        ...
                        @if ($reference->count() > 0)
                            <ul class="sp-referral">
                                <li class="single-child root-child">
                                    <p>
                                        <img src="{{ getFile('user', auth()->user()->image, true) }}">
                                        <span
                                    ...
                                    <ul class="sub-child-list step-2">
                                        @foreach ($reference as $user)
                                            <li class="single-child">
                                                <p>
                                                    <img src="{{ getFile('user', $user->image, true) }}">
                                                    <span
                                                ...
                                                <ul class="sub-child-list step-3">
                                                    @foreach ($user->refferals as $ref)
                                                        <li class="single-child">
                                                            <p>
                                                                <img src="{{ getFile('user', $ref->image, true) }}">
                                                                <span
                                                            ...
                                                            <ul class="sub-child-list step-4">
                                                                @foreach ($ref->refferals as $ref2)
                                                                    <li class="single-child">
                                                                        <p>
                                                                            <img
                                                                                src="{{ getFile('user', $ref2->image, true) }}">
                                                                            <span
