...
<body>
    ...
    <header id="header" class="fixed-top header-inner-pages">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="header-right d-flex">
                ...
                <button type="button" class="mobile-sidebar-toggler"><i class="fas fa-bars"></i></button>
            </div>
        </div>
    </header><!-- End Header -->
    ...
    <script src="{{ asset('asset/theme7/frontend/js/feather.min.js') }}"></script>

    <script src="{{ asset('asset/common/js/slick.min.js') }}"></script>

    <script src="{{ asset('asset/common/js/iziToast.min.js') }}"></script>
    <script src="{{ asset('asset/theme7/frontend/js/user_dashboard.js') }}"></script>
