...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('asset/theme7/frontend/css/cookie.css') }}">
    ...
    <link href="{{ asset('asset/theme7/frontend/css/style.css') }}" rel="stylesheet">
...
<body>
    ...
    <div class="preloader-holder">
        <div class="preloader">
        <img src="{{ asset('asset/theme7/images/logo-icon.png') }}" alt="preloader icon">
    ...
    <script src="{{ asset('asset/common/js/wow.min.js') }}"></script>
    <script src="{{ asset('asset/theme7/frontend/js/jquery.paroller.min.js') }}"></script>
    <script src="{{ asset('asset/theme7/frontend/js/TweenMax.min.js') }}"></script>
    <script src="{{ asset('asset/common/js/iziToast.min.js') }}"></script>
    <script src="{{ asset('asset/theme7/frontend/js/main.js') }}"></script>
