...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('asset/theme6/frontend/css/cookie.css') }}">
...
<body>
    ...
    <div class="preloader-holder">
        <div class="preloader">
        <img src="{{ asset('asset/theme6/images/logo-icon.png') }}" alt="preloader icon">
    ...
    <script src="{{ asset('asset/theme6/frontend/js/jquery.paroller.min.js') }}"></script>
    <script src="{{ asset('asset/theme6/frontend/js/TweenMax.min.js') }}"></script>
    <script src="{{ asset('asset/common/js/iziToast.min.js') }}"></script>
    <script src="{{ asset('asset/theme6/frontend/js/main.js') }}"></script>
