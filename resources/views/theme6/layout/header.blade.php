            ...
            <div class="row gy-2 align-items-center">
                <div class="col-lg-6 d-lg-block d-none">
                    <div class="row align-items-center gy-2">
                        <div class="col-auto">
                            <a href="tel:{{ (@$contact->data->phone) }}" class="text-white"><i class="fas fa-phone"></i> {{ __(@$contact->data->phone) }}</a>
                        </div>
                        <div class="col-auto">
                            <a href="mailto:{{ (@$contact->data->email) }}" class="text-white"><i class="fas fa-envelope"></i> {{ __(@$contact->data->email) }}</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 d-flex flex-wrap justify-content-lg-end justify-content-center align-items-center">
                    ...
                    @else
                        <a class="me-3 text-white" href="{{ route('user.login') }}"><i class="fas fa-user-plus"></i> {{ __('Login') }}</a>
                        <a href="{{route('user.register')}}" class="text-white"><i class="fas fa-sign-in-alt"></i> Sign up</a>
                    @endif
                </div>
            </div>
        </div>
