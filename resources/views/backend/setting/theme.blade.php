                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <p>
                                                <a data-route="{{ route('admin.manage.theme.update', 1) }}" data-color="#d77600"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p>
                                                <a data-route="{{ route('admin.manage.theme.update', 2) }}" data-color="#8CBE06"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p>
                                                <a data-route="{{ route('admin.manage.theme.update', 6) }}" data-color="#e51717"
                                                    class="@if ($general->theme != 6) btn btn-outline-danger btn-sm active-btn @endif @if ($general->theme == 6) text-success @else text-danger @endif font-weight-bolder">
                                                    @if ($general->theme == 6)
                                                        {{__('Activated')}}
                                                    @else
                                                        {{__('Active')}}
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p>
                                                <a data-route="{{ route('admin.manage.theme.update', 7) }}" data-color="#1d9bf0"
                                                    class="@if ($general->theme != 7) btn btn-outline-danger btn-sm active-btn @endif @if ($general->theme == 7) text-success @else text-danger @endif font-weight-bolder">
                                                    @if ($general->theme == 7)
                                                        {{__('Activated')}}
                                                    @else
                                                        {{__('Active')}}
