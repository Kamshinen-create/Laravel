                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3 mb-3">
                                        ...
                                        <div id="image-preview" class="image-preview"
                                            style="background-image:url({{ gatewayImagePath( $gateway->gateway_image) }});">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="razor_key" class="form-control"
                                                    value="{{ @$gateway->gateway_parameters->razor_key ?? old('razor_key') }}">
                                            </div>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="razor_secret" class="form-control"
                                                    value="{{ @$gateway->gateway_parameters->razor_secret ?? old('razor_secret') }}">
                                            </div>
