...
function gatewayImagePath($image = null)
{
    if($image){

        if (!file_exists('asset/common/images/gateways/'.$image)) {

            return asset("asset/common/images/placeholder.png");
        }

        return asset("asset/common/images/gateways/".$image);
    }
    return "asset/common/images/gateways";
}

function commonPath($folder_name){
    return "asset/common/images/" . $folder_name;
}
...
function getFile($folder_name, $filename, $isCommon = false)
{
    $general = GeneralSetting::first();

    if($isCommon){
        return asset("asset/common/images/".$folder_name.'/'.$filename);
    }
...
function templateSection()
{
    ...
    return $general->theme == 1 ? 'frontend' : 'theme'.$general->theme;
}
