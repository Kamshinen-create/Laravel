...
class AdminController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $admin =  Admin::create([
            ...
            'image' => $request->has('admin_image') ? uploadImage($request->admin_image, commonPath('admins')) : ''
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $admin->update([
            ...
            'image' => $request->has('admin_image') ? uploadImage($request->admin_image, commonPath('admins')) : $admin->image
        ]);
