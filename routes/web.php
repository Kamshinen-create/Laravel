...
use App\Http\Controllers\Gateway\paypal\ProcessController as PaypalPaymentController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin', 'demo'])->group(function () {
        ...
        Route::middleware('permission:manage-logs,admin')->group(function () {
            ...
            Route::get('commission/{user?}', [ReferralController::class, 'commission'])->name('commission');
        });
...
Route::name('user.')->group(function () {
    ...
    Route::middleware('guest')->group(function () {
        ...
        Route::post('login', [AuthLoginController::class, 'login'])->middleware('throttle:5,1');

        Route::get('forgot/password', [AuthForgotPasswordController::class, 'index'])->name('forgot.password');
        Route::post('forgot/password', [AuthForgotPasswordController::class, 'sendVerification'])->middleware('throttle:3,1');
        Route::get('verify/code', [AuthForgotPasswordController::class, 'verify'])->name('auth.verify');
        Route::post('verify/code', [AuthForgotPasswordController::class, 'verifyCode'])->middleware('throttle:5,1');
        Route::get('reset/password', [AuthForgotPasswordController::class, 'reset'])->name('reset.password');
        Route::post('reset/password', [AuthForgotPasswordController::class, 'resetPassword'])->middleware('throttle:3,1');
    ...
    Route::middleware(['auth', 'inactive', 'is_email_verified'])->group(function () {
        ...
        Route::middleware('2fa','kyc')->group(function () {
            ...
            Route::post('withdraw', [UserController::class, 'withdrawCompleted'])->middleware('throttle:10,1');
            ...
            Route::post('investmentplan/invest', [SiteController::class, 'investmentUsingBalannce'])->name('investmentplan.submit')->middleware('throttle:5,1');
            ...
            Route::get('payment-success', [PaypalPaymentController::class, 'ipn'])->name('payment.success');
            ...
            Route::post('transfer-money', [UserController::class, 'transferMoney'])->middleware('throttle:10,1');
